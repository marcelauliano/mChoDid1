# ====================================
# Sloth Retrocopy Density Plot (on screen)
# ====================================
...
# 1. Load custom genome file (with columns: chr, start, end)
...
# 3. Convert retrocopy data to GRanges
...
# 5. Create plot (no default labels)
...
# 6. Plot retrocopy density in light red
kpPlotDensity(kp,
              data = retrocopies,
              data.panel = 1,
...
# 7. Add chromosome names (clean and custom)
